...
public class yadayadaAppModel extends AppModelBase {		private SearchEditField SearchEditField;
	private GoogleSearchButton GoogleSearchButton;
	private YadaLink YadaLink;
	
	public yadayadaAppModel(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("yadayadaAppModel");
				SearchEditField = new SearchEditField(contextTestObject, this);
		GoogleSearchButton = new GoogleSearchButton(contextTestObject, this);
		YadaLink = new YadaLink(contextTestObject, this);
		rebuildDescriptions();
	}	
		...
		public YadaLink YadaLink() { return YadaLink; }
		...
		public class SearchEditField extends EditFieldNodeBase
	{
		...
		protected com.hp.lft.sdk.web.EditFieldDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.EditFieldDescription.Builder().name("q").tagName("INPUT").type("text").build();
			}catch(Exception e){
	...
	public class GoogleSearchButton extends ButtonNodeBase
	{
		...
		protected com.hp.lft.sdk.web.ButtonDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.ButtonDescription.Builder().buttonType("submit").name("Google Search").tagName("INPUT").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class YadaLink extends LinkNodeBase
	{

		
								public YadaLink(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("Urban Dictionary: Yada yada yada");
		}
		...
		protected com.hp.lft.sdk.web.LinkDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.LinkDescription.Builder().innerText("Urban Dictionary: Yada yada yada").tagName("A").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
